...
| كلماتي مع أشيائي: اسمع وأشر وسمِّ | جلسة مفردات بصرية وسمعية قابلة للتكرار ينتج عنها استجابة ذات معنى: إشارة أو اختيار أو تسمية أو تقليد، مع ملاحظة وصفية من المرافق عند الحاجة، بلا تشخيص أو درجة آلية للنطق. | يعمل الآن | [المواصفات](../apps/1-4/say-and-name/BUILD_SPEC.md) · [المطالبة](../apps/1-4/say-and-name/PROMPT_AR.md) |
| دوري ودورك: قلّد حركة واحدة | تجربة لعب مشترك منفذة في الواقع مع ملاحظة قصيرة لما نجح وما يحتاج تبسيطًا أو تطويرًا في المرة التالية. | يعمل الآن | [المواصفات](../apps/1-4/imitate-one-step/BUILD_SPEC.md) · [المطالبة](../apps/1-4/imitate-one-step/PROMPT_AR.md) |
| ألعاب إبداعية عبر الشاشة — أو بدون الشاشة | لعبة جاهزة أو لعبة مصممة من المرافق يمكن تنفيذها تفاعليًا أو تحويلها إلى ورقة أو نشاط واقعي، مع نتيجة تصف الجولة الحالية فقط. | يعمل الآن | [المواصفات](../apps/1-4/screen-to-move/BUILD_SPEC.md) · [المطالبة](../apps/1-4/screen-to-move/PROMPT_AR.md) |
| مشاعري معك: أحتاج مساعدة | خطة تنظيم مشترك وانتقال مصورة قابلة للاستخدام اللحظي والحفظ والطباعة، تربط الإشارة أو الشعور بالمساعدة المقبولة والخطوة التالية وملاحظة المرافق بعد الموقف. | مخطط | [المواصفات](../apps/1-4/calm-with-me/BUILD_SPEC.md) · [المطالبة](../apps/1-4/calm-with-me/PROMPT_AR.md) |
| سلة الاكتشاف: فرز ولمس ونقل | مهمة لعب حسية حركية آمنة قابلة للتخصيص والطباعة، مرتبطة بمواد واقعية وخطوة واضحة وبديل أسهل أو أكثر تحديًا وملاحظة للمرافق بعد التنفيذ. | مخطط | [المواصفات](../apps/1-4/sensory-motion-missions/BUILD_SPEC.md) · [المطالبة](../apps/1-4/sensory-motion-missions/PROMPT_AR.md) |
| أستطيع خطوة: روتيني المصور | روتين بصري شخصي قابل للحفظ والطباعة والتنفيذ خطوة بخطوة، مع ملاحظة مقدار المساعدة وخيارات تبسيط أو اختصار دون سلاسل نجاح عقابية. | مخطط | [المواصفات](../apps/1-4/my-little-routine/BUILD_SPEC.md) · [المطالبة](../apps/1-4/my-little-routine/PROMPT_AR.md) |
| رفيق المرافق: خطط جلسة لعب مستجيبة | خطة جلسة لعب مستجيبة قابلة للطباعة والتنفيذ، مع بطاقة تذكير للمرافق أثناء اللعب وسجل ملاحظة بعده يقود إلى تعديل واضح للجلسة التالية. | مخطط | [المواصفات](../apps/1-4/responsive-play-coach/BUILD_SPEC.md) · [المطالبة](../apps/1-4/responsive-play-coach/PROMPT_AR.md) |
