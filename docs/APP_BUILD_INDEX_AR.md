...
| دوري ودورك: قلّد حركة واحدة | محاولة تبادل دور بين الطفل والمرافق باستخدام لعبة حقيقية. | يعمل الآن | [المواصفات](../apps/1-4/imitate-one-step/BUILD_SPEC.md) · [المطالبة](../apps/1-4/imitate-one-step/PROMPT_AR.md) |
| ألعاب إبداعية عبر الشاشة — أو بدون الشاشة | ورقة أو بطاقة لعب واقعية، أو نتيجة جولة لعب داخل الشاشة، مرتبطة بفكرة مصورة واضحة يختارها الطفل والمرافق. | يعمل الآن | [المواصفات](../apps/1-4/screen-to-move/BUILD_SPEC.md) · [المطالبة](../apps/1-4/screen-to-move/PROMPT_AR.md) |
