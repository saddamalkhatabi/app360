var CACHE='app360-template-v2';
var SHELL=['./','./index.html','./manifest.webmanifest','./icon.svg','./app.json','../../../assets/js/app360-ai-shell.js?v=2','../../../assets/js/ai-content-studio.js?v=2','../../../assets/js/app-pwa.js?v=2'];
