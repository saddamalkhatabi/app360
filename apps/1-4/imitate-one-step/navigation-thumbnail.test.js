...
const js=fs.readFileSync('app-v13.js','utf8');const html=fs.readFileSync('index.html','utf8');const manifest=JSON.parse(fs.readFileSync('storyboards/manifest.json','utf8'));
...
test('index points to v13 runtime and style',()=>{assert.ok(html.includes('app-v13.js?v=1'));assert.ok(html.includes('styles-v13.css?v=1'))});