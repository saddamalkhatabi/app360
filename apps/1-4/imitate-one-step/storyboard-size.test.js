...
const css=fs.readFileSync('styles-v15.css','utf8');const html=fs.readFileSync('index.html','utf8');
...
test('index loads v15 styles',()=>{assert.ok(html.includes('styles-v15.css?v=1'))});