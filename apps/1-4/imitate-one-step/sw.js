var CACHE='app360-app-imitate-one-step-v3';
var SHELL=['./','./index.html','./styles.css?v=2','./app-v3.js','./tasks.js?v=2','./practice-core.js?v=2','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png','./app.json','../../../assets/js/app-pwa.js?v=1'];
