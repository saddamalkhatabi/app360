...
const app=fs.readFileSync('app-v14.js','utf8'),html=fs.readFileSync('index.html','utf8'),icons=JSON.parse(fs.readFileSync('icons/manifest.json','utf8')),sb=JSON.parse(fs.readFileSync('storyboards/manifest.json','utf8'));
...
test('v14 shell is wired',()=>{assert.ok(html.includes('app-v14.js?v=1'));assert.ok(html.includes('styles-v14.css?v=1'))});