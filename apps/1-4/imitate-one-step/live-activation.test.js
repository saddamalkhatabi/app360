...
test('001 has dedicated cover icon and active photographic storyboard',()=>{assert.equal(icons.assets['001'],'icons/001.svg');assert.equal(sb.assets['001'],'storyboards/001.webp');assert.ok(fs.existsSync('icons/001.svg'));assert.ok(fs.existsSync('storyboards/001.webp'))});
...
test('v16 shell is wired',()=>{assert.ok(html.includes('app-v16.js?v=5'));assert.ok(html.includes('styles-v16.css?v=4'))});
