...
if(index.indexOf('calm-with-me-v9-20260923')<0)fail('connected journey base marker missing');
...
if(sw.indexOf('app360-app-calm-with-me-v11')<0||sw.indexOf('scenario-engine-v6')>=0||sw.indexOf('app-links-registry')>=0)fail('calm service worker must remain separated from cross-app planner assets');
console.log('calm-with-me base journey + v10 maturity + v11 cache planner separation validation OK');
