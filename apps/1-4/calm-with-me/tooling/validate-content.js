...
if(!Array.isArray(lib.situations)||lib.situations.length<40)fail('emotion school requires at least forty situations');else ok('emotion school situations: '+lib.situations.length);
