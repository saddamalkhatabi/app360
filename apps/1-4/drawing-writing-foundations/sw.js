var CACHE='app360-drawing-writing-v23';
var SHELL=['./','./index.html','./manifest.json','./icon.svg','./icon-192.png','./icon-512.png','./sync-v10-extra.js','./ui-v11.js?v=19','./audio-pcm-v18.js?v=18','./audio-v21.js?v=21','./version.json','./app.json'];
