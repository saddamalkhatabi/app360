...
['app360HomeBtn','🏠 الرئيسية','ai-content-studio.js?v=2','app360-login-entry-v2.js?v=2','app360-usage-daily-v1.js?v=1','/apps/','APP360_LEGACY'].forEach(x=>{if(shell.indexOf(x)<0)fail('AI shell missing '+x)});
...
const pwa=read('assets/js/app-pwa.js');if(pwa.indexOf('app360-ai-shell.js?v=5')<0)fail('PWA runtime does not autoload latest shared AI shell');else ok('PWA shell autoload enabled');
