...
const pwa=read('assets/js/app-pwa.js');if(pwa.indexOf('app360-ai-shell.js?v=6')<0)fail('PWA runtime does not autoload latest shared AI shell');else ok('PWA shell autoload enabled');
