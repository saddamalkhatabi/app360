...
المصدر الرئيسي للشعار هو `assets/brand/app360-lab-mark.svg` بخلفية شفافة. منه تُشتق أيقونات PWA والأحجام الصغيرة، ولا يوضع الشعار داخل مربع أبيض أو بطاقة منفصلة في الواجهة. في الصفحة الرئيسية يظهر الرمز كعنصر جانبي متناسق مع الخلفية، وتستخدم بوابات الأعمار نفس العلامة المشتركة.
