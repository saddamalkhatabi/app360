...
## الهوية البصرية للبوابة

المصدر المعتمد للشعار هو `assets/brand/app360-lab-logo-transparent.png`: **نفس الشعار الأصلي المعتمد، مع إزالة الخلفية البيضاء فقط من دون إعادة تصميم**. وتُشتق أيقونات PWA من رمز الشعار الأصلي نفسه مع الحفاظ على النسب والعناصر والألوان، ولا تستخدم البوابة أي إعادة رسم بديلة للشعار.

الألوان الأساسية: تركواز `#0A9BA8`، بترولي داكن `#063F4B`، وذهبي إبراز `#F4C027`.
