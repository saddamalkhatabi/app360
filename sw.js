var CACHE='app360-portal-v4';
var CORE=[
  './','./index.html','./manifest.webmanifest?v=4',
  './assets/css/lab360.css?v=3',
  './assets/js/lab360.js?v=2','./assets/js/pwa-install.js?v=1',
  './assets/brand/app360-lab-logo.webp?v=4',
  './assets/brand/app360-lab-icon-192.png?v=4','./assets/brand/app360-lab-icon-512.png?v=4',
...
self.addEventListener('fetch',function(e){
  ...
  var isBrand=url.indexOf('/assets/brand/')>=0||url.indexOf('/manifest.webmanifest')>=0;
  if(req.mode==='navigate'){e.respondWith(networkFirst(req,'./index.html'));return}
  if(isData||isBrand){e.respondWith(networkFirst(req));return}
