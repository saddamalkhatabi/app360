var CACHE='app360-portal-v8';
var CORE=[
  './','./index.html?v=8','./manifest.webmanifest?v=8',
  './assets/css/lab360.css?v=4','./assets/css/brand-v7.css?v=8',
  './assets/js/lab360.js?v=4','./assets/js/pwa-install.js?v=4',
  './assets/brand/app360-lab-logo-transparent.png?v=8',
  './assets/brand/app360-lab-icon-180.png?v=8','./assets/brand/app360-lab-icon-192.png?v=8','./assets/brand/app360-lab-icon-512.png?v=8',
...
self.addEventListener('fetch',function(e){var req=e.request;if(!req||req.method!=='GET'||!sameOrigin(req))return;var url=req.url||'';var isData=url.indexOf('/data/catalog.json')>=0||url.indexOf('/data/goals.json')>=0;var isBrand=url.indexOf('/assets/brand/')>=0||url.indexOf('/manifest.webmanifest')>=0;if(req.mode==='navigate'){e.respondWith(networkFirst(req,'./index.html?v=8'));return}if(isData||isBrand){e.respondWith(networkFirst(req));return}e.respondWith(staleWhileRevalidate(req))});
