...
self.addEventListener('fetch',function(e){var req=e.request;if(!req||req.method!=='GET'||!sameOrigin(req))return;var url=req.url||'';var isData=url.indexOf('/data/catalog.json')>=0||url.indexOf('/data/goals.json')>=0||url.indexOf('/data/live-overrides.json')>=0;var isPortalLogic=url.indexOf('/assets/js/lab360')>=0||url.indexOf('/assets/js/swal-modern-loader')>=0||url.indexOf('/assets/js/pwa-install')>=0;var isBrand=url.indexOf('/assets/brand/')>=0||url.indexOf('/manifest.webmanifest')>=0;if(req.mode==='navigate'){e.respondWith(networkFirst(req,'./index.html'));return}if(isData||isPortalLogic||isBrand){e.respondWith(networkFirst(req));return}e.respondWith(staleWhileRevalidate(req))});
