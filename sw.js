var CACHE='app360-portal-v29';
var CORE=[
  './','./index.html',
  './assets/css/lab360.css','./assets/css/legacy-compat.css','./assets/css/home-showcase-v29.css',
  './assets/js/lab360-v24.js','./assets/js/home-showcase-v29.js','./assets/js/swal-modern-loader-v24.js','./assets/js/pwa-install-v24.js',
  './assets/brand/app360-lab-logo.png','./assets/brand/app360-lab-icon-192.png','./assets/brand/app360-coming-soon.svg',
...
self.addEventListener('fetch',function(e){var req=e.request;if(!req||req.method!=='GET'||!sameOrigin(req))return;var url=req.url||'';var isData=url.indexOf('/data/catalog.json')>=0||url.indexOf('/data/goals.json')>=0||url.indexOf('/data/live-overrides.json')>=0;var isPortalLogic=url.indexOf('/assets/js/lab360')>=0||url.indexOf('/assets/js/home-showcase')>=0||url.indexOf('/assets/js/swal-modern-loader')>=0||url.indexOf('/assets/js/pwa-install')>=0;var isBrand=url.indexOf('/assets/brand/')>=0||url.indexOf('/manifest.webmanifest')>=0;var isPortalStyle=url.indexOf('/assets/css/home-showcase')>=0||url.indexOf('/assets/css/lab360')>=0;if(req.mode==='navigate'){e.respondWith(networkFirst(req,'./index.html'));return}if(isData||isPortalLogic||isBrand||isPortalStyle){e.respondWith(networkFirst(req));return}e.respondWith(staleWhileRevalidate(req))});