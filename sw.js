var CACHE='app360-portal-v17';
var CORE=[
  './','./index.html?v=12','./manifest.webmanifest?v=11',
  './assets/css/lab360.css?v=16',
  './assets/js/lab360.js?v=17','./assets/js/pwa-install.js?v=16',
...
self.addEventListener('fetch',function(e){var req=e.request;if(!req||req.method!=='GET'||!sameOrigin(req))return;var url=req.url||'';var isData=url.indexOf('/data/catalog.json')>=0||url.indexOf('/data/goals.json')>=0||url.indexOf('/data/live-overrides.json')>=0;var isBrand=url.indexOf('/assets/brand/')>=0||url.indexOf('/manifest.webmanifest')>=0;var isPortalLogic=url.indexOf('/assets/js/lab360.js')>=0;if(req.mode==='navigate'){e.respondWith(networkFirst(req,'./index.html?v=12'));return}if(isData||isBrand||isPortalLogic){e.respondWith(networkFirst(req));return}e.respondWith(staleWhileRevalidate(req))});
